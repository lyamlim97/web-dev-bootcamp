...
from movie_library.forms import (ExtendedMovieForm, LoginForm, MovieForm,
                                 RegisterForm)
...
def register():
    ...
    if form.validate_on_submit():
        user = User(_id=uuid.uuid4().hex, email=form.email.data,
...
def add_movie():
    ...
    if form.validate_on_submit():
        movie = Movie(_id=uuid.uuid4().hex, title=form.title.data,
